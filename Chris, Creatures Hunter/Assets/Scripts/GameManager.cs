...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        visualAmmo = GameObject.Find("Ammo").GetComponent<Image>();
    ...
    void Health()
    {
        visualHealth.fillAmount = (hero.Health * 1) / 100;
        visualHealth.color = Color.Lerp(Color.red, Color.green, (hero.Health * 1) / 100);
    }
